...
<link rel="stylesheet" href="<c:url value='/resources/admin/css/morris.css' />" type="text/css"/>
<!-- Graph CSS -->
...
<link rel="stylesheet" href="<c:url value='/resources/admin/css/icon-font.min.css' />" type='text/css' />
<!-- //lined-icons -->
<link rel="stylesheet" href="<c:url value='/resources/admin/css/demobar_w3_4thDec2019.css' />"/>
</head> 
<body>
<script src='<c:url value='/resources/admin/js/jquery.min.js' />'></script><script src="//m.servedby-buysellads.com/monetization.js" type="text/javascript"></script>
<script>
(function(){
...
<script async src='<c:url value='/resources/admin/js/autotrack.js' />'></script>
...
<body>
  ...
  <a href="https://w3layouts.com/?p=23592" ga-on="click" ga-event-category="Pooled Admin Panel Template" ga-event-action="view" ga-event-label="Pooled Admin Panel - view">
  ...
  <div class="w3l-template-options">
    <a href="https://w3layouts.com/?p=23592"
      class="w3l-download" ga-on="click" ga-event-category="Pooled Admin Panel Template" ga-event-action="download-options" ga-event-label="Pooled Admin Panel - Download options" title="Free download requires Backlink">
    ...
    <a href="https://w3layouts.com/?p=23592"
      class="w3l-buy" ga-on="click" ga-event-category="Pooled Admin Panel Template" ga-event-action="Buy Now" ga-event-label="Pooled Admin Panel - Buy" title="Remove Backlink from template">
								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="<c:url value='/resources/admin/image/in1.jpg' />" alt=""></div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="<c:url value='/resources/admin/image/in1.jpg' />" alt=""> </span> 
												<div class="user-name">
													<p>Malorum</p>
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                <img class="lg-item-img" src="<c:url value='/resources/admin/image/in1.jpg' />" alt="">
                                            </div>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href='<c:url value="/themsanpham" />'><i class="fa fa-envelope nav_icon"></i><span>Sản phẩm</span><div class="clearfix"></div></a></li>
...
<script src="<c:url value='/resources/admin/js/morris.js' />"></script>
<script>
	$(document).ready(function() {
